...
class World(object):
    ...
    def restart(self):
        ...
        if self.player is not None:
            ...
            spawn_point.location.x = -202.4
            spawn_point.location.y = -143.3
        ...
        while self.player is None:
            ...
            spawn_point.location.z += 2.0
            spawn_point.location.x = -200.4
            spawn_point.location.y = -143.3
            spawn_point.rotation.roll = 45.0
        ...
        # wheels[0].lat_stiff_value=7.
        # wheels[1].lat_stiff_value=7.
        # wheels[2].lat_stiff_value=7.
        # wheels[3].lat_stiff_value=7.
