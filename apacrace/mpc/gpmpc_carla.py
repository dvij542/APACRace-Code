		...
		for idh in range(horizon):
			...
			if error_correction:
				...
				for i in range(1) :
					...
					Ffy = Fy_model(*Ffy_ins)[0]*params['mass']
					Ffy_ins_ = [-alpha_f] + Fy_inps
					Ffy_ = Fy_model(*Ffy_ins_)[0]*params['mass']
					Ffy = cs.if_else(alpha_f>0.,Ffy,-Ffy_)
					
					Fry_ins = [alpha_r] + Ry_inps
					Fry = Ry_model(*Fry_ins)[0]*params['mass']
					Fry_ins_ = [-alpha_r] + Ry_inps
					Fry_ = Ry_model(*Fry_ins_)[0]*params['mass']
